...
function route() {
  ...
  const {user}=useUser
   const getUpgradeStatus=useMutation(api.participants.userPlan);


  const paymentDone=async()=>{
   const result=await getUpgradeStatus({userEmail:user?.primaryEmailAddress?.emailAddress});
   console.log(result+"------------");
  ...
  return (
    <div>
      ...
      <h2>Update your plan to upload mutiple images</h2>
    ...
    <div className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
      ...
      <ul className="mt-6 space-y-2">
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700">5 PDF uploaded</span>
        </li>
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> Unlimited Note Making </span>
        </li>
